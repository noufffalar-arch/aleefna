    ...
    extend: {
      ...
      colors: {
        ...
        aleefna: {
          ...
          "blue-light": "hsl(var(--aleefna-blue-light))",
          purple: "hsl(var(--aleefna-purple))",
          "purple-light": "hsl(var(--aleefna-purple-light))",
          red: "hsl(var(--aleefna-red))",
          "red-light": "hsl(var(--aleefna-red-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
